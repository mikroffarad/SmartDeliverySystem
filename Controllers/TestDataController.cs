...
namespace SmartDeliverySystem.Controllers
{
    ...
    public class TestDataController : ControllerBase
    {
        ...
        public async Task<ActionResult> SeedTestData()
        {
            ...
            {
                new Product { Name = "Хліб білий", Weight = 0.4m, Category = "Хлібобулочні", Price = 25.50m },
                new Product { Name = "Молоко 2.5%", Weight = 1.0m, Category = "Молочні", Price = 32.00m },
                new Product { Name = "Яблука червоні", Weight = 1.0m, Category = "Фрукти", Price = 45.00m },
                new Product { Name = "Курячі яйця", Weight = 0.6m, Category = "Молочні", Price = 55.00m },
                new Product { Name = "Макарони", Weight = 0.5m, Category = "Крупи", Price = 28.50m }
            };
